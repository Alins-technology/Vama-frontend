...
export const treatments = [
  ...
  // ---------------- ALLERGY ----------------
  {
    ...
    article: [
      ...
      {
        type: "paragraph",
        text: "If you're noticing any of these symptoms, consulting a skin specialist at your nearest VAMA branch — whether in Noida, Lajpat Nagar, Indirapuram, Lucknow, Agra or Kanpur — can help prevent the condition from worsening.",
        links: [{ text: "consulting a skin specialist", to: "/contact-us" }],
      },
      { type: "heading", text: "What Causes Psoriasis?" },
      {
        type: "paragraph",
        text: "Psoriasis occurs when the immune system mistakenly attacks healthy skin cells, speeding up skin cell production. While the exact cause isn't fully understood, several factors are known to trigger or worsen psoriasis:",
      },
      {
        type: "list",
        items: [
          ...
          "Stress and anxiety",
          "Skin injuries (cuts, sunburn, insect bites)",
          "Certain infections",
          "Cold, dry weather",
      ...
      {
        type: "paragraph",
        text: "At our clinics across Noida, Lajpat Nagar, Indirapuram, Lucknow, Agra and Kanpur, we diagnose and treat all major types of psoriasis, including:",
      },
      {
        type: "list",
        items: [
          "Plaque Psoriasis — the most common form, causing raised, scaly patches",
          "Scalp Psoriasis — affecting the scalp with flaking and itching",
          ...
          "Nail Psoriasis — pitting, discoloration and thickening of nails",
          "Psoriatic Arthritis — joint pain and swelling associated with psoriasis",
        ],
      },
      { type: "heading", text: "How Can Psoriasis Be Resolved?" },
      {
        type: "paragraph",
      ...
      },
      {
        type: "steps",
        items: [
          "Topical Treatments — medicated creams, ointments and corticosteroids to reduce inflammation, itching and scaling directly at the affected areas.",
          "Phototherapy — controlled exposure to UV light to slow down skin cell turnover and reduce plaques, especially effective for moderate to widespread psoriasis.",
          "Oral & Systemic Medications — for moderate to severe cases, oral medications or biologic therapies may be recommended to control the immune response from within.",
          "Lifestyle & Skincare Guidance — practical advice on diet, stress management, skincare routines and trigger avoidance to reduce the frequency and severity of flare-ups.",
          "Regular Monitoring — since psoriasis is a chronic condition, we provide ongoing follow-ups to adjust your treatment plan as needed and track long-term improvement, available at every VAMA branch.",
        ],
      },
      { type: "heading", text: "Key Features of Psoriasis Treatment at VAMA Clinics" },
      {
        type: "list",
        items: [
          "Multi-Location Access — visit us in Noida, Lajpat Nagar, Indirapuram, Lucknow, Agra or Kanpur, whichever is closest to you",
          "Experienced Dermatologists with years of expertise in treating chronic skin conditions",
          "Personalized Treatment Plans tailored to your specific skin type and psoriasis severity",
          "Advanced Diagnostic Tools for accurate assessment before treatment begins",
          "Combination Therapies — topical, phototherapy and systemic options as needed",
          "Hygienic, Comfortable Clinics designed for patient comfort",
          "Affordable Treatment Packages with transparent, upfront pricing",
          "Ongoing Support & Follow-Ups through every stage of your treatment journey",
        ],
      },
      { type: "heading", text: "Why Choose VAMA Clinics?" },
      {
        type: "list",
        items: [
          "Wide Reach, Consistent Quality — whether you visit our Noida, Lajpat Nagar, Indirapuram, Lucknow, Agra or Kanpur branch, you get the same high standard of care and expertise",
          "Doctor-Led Diagnosis — every treatment plan starts with a thorough consultation, not guesswork",
          "Proven Track Record — years of experience treating chronic skin conditions like psoriasis, eczema and other allergies",
          "Transparent Communication — clear explanation of your condition, treatment options and expected timelines",
          "Patient-Centric Approach — flexible appointment scheduling and continuous support even after your visible symptoms improve",
          "Affordable, Accessible Care — quality dermatology treatment without the premium price tag of larger hospital chains",
        ],
      },
      { type: "heading", text: "Book Your Psoriasis Consultation Today" },
      {
        type: "paragraph",
    ...
    faqs: [
      { q: "Is psoriasis curable?", a: "Psoriasis is a chronic condition, which means it can be effectively managed and controlled, though there's currently no permanent cure. With the right treatment, most patients see significant improvement and long periods of clear skin." },
      { q: "Is psoriasis contagious?", a: "No, psoriasis is not contagious. It cannot spread through touch or contact with an affected person." },
      { q: "How long does treatment take to show results?", a: "This depends on the type and severity of psoriasis. Some patients notice improvement within a few weeks, while others may need a few months of consistent treatment for visible results." },
      { q: "Can diet affect psoriasis?", a: "Yes, certain foods can trigger inflammation and worsen symptoms in some people. Our specialists can guide you on dietary adjustments that may help manage flare-ups." },
      { q: "Which VAMA branch should I visit for psoriasis treatment?", a: "You can visit whichever VAMA Clinics branch is most convenient for you — Noida, Lajpat Nagar, Indirapuram, Lucknow, Agra or Kanpur. All branches offer the same quality diagnosis and treatment standards." },
    ],
  },
  {
